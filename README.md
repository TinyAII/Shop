...
### 通用
- **双币结算**：官方商店/世界商店商品均可指定结算币种（金币或点券），配合 TinyAII Economy v2.0 双货币；GUI 余额同时显示金币+点券
...
| `/商店 上架 <单价> [数量] [金币\|点券]` | 手持物品挂售到世界商店（可选收币种） | shop.use |
| `/商店 我的` | 查看我的挂售单 | shop.use |
| `/商店 下架 <单号>` | 收回挂售商品 | shop.use |
| `/商店 管理 上架 <买价\|0> <卖价\|0> [分类] [库存] [金币\|点券]` | 官方商店上架（0=关闭，币种可选） | shop.admin |
